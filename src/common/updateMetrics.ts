...
export function updatePoolDayData(event: ethereum.Event): PoolDayData {
  ...
  if (poolDayData === null) {
    ...
    poolDayData.volumeToken0 = BIGDECIMAL_ZERO
    poolDayData.volumeToken1 = BIGDECIMAL_ZERO
    poolDayData.volumeUSD = BIGDECIMAL_ZERO
    poolDayData.feesUSD = BIGDECIMAL_ZERO
    poolDayData.txCount = BIGINT_ZERO
    poolDayData.feeGrowthGlobal0X128 = BIGINT_ZERO
    poolDayData.feeGrowthGlobal1X128 = BIGINT_ZERO
  ...
  poolDayData.close = pool.token0Price
  poolDayData.priceVariation = (poolDayData.close.div(poolDayData.open)).minus(BIGDECIMAL_ONE)
  poolDayData.tick = pool.tick
  poolDayData.tvlUSD = pool.totalValueLockedUSD
  poolDayData.txCount = poolDayData.txCount.plus(BIGINT_ONE)
  poolDayData.save()
